...
| R-05 | **Integração visual sem acesso ao design** da Alphractal | Alta | Médio | Destravar na dúvida nº 11 já no kick-off; se não houver design system, propor um e obter validação formal na semana 1 |
